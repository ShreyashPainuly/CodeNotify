...
function formatDigestEmail(contests, frequency) {
    ...
    const contestsHtml = contests
        .map((contest, index) => {
        const platformColor = platformColors[contest.platform.toLowerCase()] || '#6366f1';
...
//# sourceMappingURL=digest-email.template.js.map